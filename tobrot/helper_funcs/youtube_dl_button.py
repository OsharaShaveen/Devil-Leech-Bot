...
import pyrogram
from tobrot import AUTH_CHANNEL, DOWNLOAD_LOCATION, LOGGER, Gdown_COMMAND
...
async def youtube_dl_call_back(bot, update):
    ...
    if not os.path.isdir(user_working_dir):
        ...
        return
    save_down_json_path = user_working_dir + "/" + str("downeech") + ".json"
    try:
        with open(save_down_json_path, "r", encoding="utf8") as f:
            response_json = json.load(f)
        os.remove(save_down_json_path)
