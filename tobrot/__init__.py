...
down_COMMAND = os.environ.get("down_COMMAND", "down")
Gdown_COMMAND = os.environ.get("Gdown_COMMAND", "gdown")
...
Pdown_COMMAND = os.environ.get("Pdown_COMMAND", "pdown")
GPdown_COMMAND = os.environ.get("GPdown_COMMAND", "gpdown")
